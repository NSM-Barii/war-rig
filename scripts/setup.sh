...
apt update -qq
apt install -y tshark hostapd dnsmasq rfkill iw bluetooth bluez kismet python3 python3-venv bc dkms build-essential git libelf-dev raspberrypi-kernel-headers
